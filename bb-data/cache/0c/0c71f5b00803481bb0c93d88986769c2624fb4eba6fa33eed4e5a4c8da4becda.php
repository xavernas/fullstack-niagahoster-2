...
/* partial_menu.phtml */
class __TwigTemplate_4b0695c72ce1625a7cf1ef33b34535368ab02bea5e6749e7a4d849e28f19f4a5 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "C:\\xampp\\htdocs\\BoxBilling/bb-themes\\admin_default\\html/partial_menu.phtml");
    }
}
